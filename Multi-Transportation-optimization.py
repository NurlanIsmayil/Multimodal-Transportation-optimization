# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 11:58:24 2024

@author: Nurlan Ismayil
"""
...
def transform(filePath):
    ...
    order = pd.read_excel(r'C:\\Users\\Galaxy Computers\\Downloads\\data.xlsx', sheet_name='Order Information')
    route = pd.read_excel(r'C:\\Users\\Galaxy Computers\\Downloads\\data.xlsx', sheet_name='Route Information')
...
if __name__ == '__main__':
    order, route = transform("r'C:\\Users\\Galaxy Computers\\Downloads\\data.xlsx'")
    m = MMT()
